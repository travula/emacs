...
(cond ((not inferior-scheme-mode-map)
       (setq inferior-scheme-mode-map (copy-keymap comint-mode-map))
...
to continue it."
  ...
  (run-hooks  'scheme-mode-hook 'inferior-scheme-mode-hook) ; vc 4/8/94
)
...
;;; 4/8/94
;;; - run-hooks runs scheme-mode-hook before inferior-scheme-mode-hook
