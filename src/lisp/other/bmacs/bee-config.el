...
;*    Last change :  Wed Oct 29 06:00:14 2003 (serrano)                */
;*    -------------------------------------------------------------    */
...
(defcustom bee-font-lock-keywords
  (list
   ...
   (list (concat "\(\\(type\\|export\\|import\\|option\\|eval\\|main\\|with"
   ...
   (list (concat "\(\\(error\\|warning\\|pragma\\|trace\\|"
	 ...
	 1
	 'ude-font-lock-face-2)
   (list (concat "\(\\(make-thread\\>\\|thread-start!\\>\\|thread-yield!\\>"
		 ...
		 "\\|thread-name\\>\\|thread-name-set!\\>\\|thread[?]\\>"
		 ...
		 "\\|make-input-signal\\|make-send-chars-signal\\>"
		 "\\|make-output-signal\\>"
		 "\\|make-connect-signal\\>\\|make-accept-signal\\>"
		 "\\|make-process-signal\\|make-sleep-signal\\>\\)")
	 1
