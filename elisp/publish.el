...
;;; Usage:
;;; This file is to be called from the parent directory:
...
;;; do not evaluate any code blocks
(setq org-export-babel-evaluate nil)

;;; allow org-files to  bind elisp variables
...
;;; directory where sources reside
(defvar *src-dir*   (concat *base-dir* "src/"))
;;; directory where org files reside
(defvar *org-dir*   (concat *src-dir* "org/"))
;;; directory where elisp libraries reside
(defvar *lisp-dir*   (concat *src-dir* "lisp/"))
...
;;; org-publish-docs: org-dir  -- publish-to-html        -> docs-dir
;;; org-attach-docs:  org-dir  -- org-publish-attachment -> docs-dir
;;; lisp-attach-code: lisp-dir -- org-publish-attachment -> code-dir
;;; org-tangle-code:  org-dir  -- tangle-wrapper         -> code-dir


;;; exports org files to html and leaves them in  docs
(setq org-publish-docs
	  `("org-publish-docs"
...
;;; copies non org (static) files  to docs
(setq lisp-attach-code
	  `("lisp-attach-code"
		:base-directory ,*lisp-dir*
		:base-extension "el"
...
;;; tangles code out from the *org-dir*
(setq org-tangle-code
	  `("org-tangle-code"
		:base-directory ,*org-dir*
		:base-extension "org"
		:publishing-directory ,*code-dir*
